    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="edit-theloai.php?category_id=<?php echo $row['category_id']; ?>""><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a><span style="margin: 0px 5px;"></span><a href="delete-theloai.php?category_id=<?php echo $row['category_id']; ?>" aria-hidden="true"><i class="fa fa-trash-o" style="color: red;" aria-hidden="true"></i></a></td>
            ...
            <footer class="footer text-center">
              <p>&copy;Copyright Jacktks | 2020</p>
            </footer>
