	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url(images/banner-02.jpg);">
				...
				<div class="item-slick1" style="background-image: url(images/slide-bag2.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Bags Collection 2020
								</span>
							</div>
				...
				<div class="item-slick1" style="background-image: url(images/slide-watches2.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Watches Collection 2020
								</span>
							</div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="images/product-11.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="images/bag-product5.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="images/watches-product2.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="images/product-12.jpg" alt="IMG-BANNER">
