            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    if(isset($_POST['update'])){
                        ...
                        if($filename == ""){
                            $qrup = "update users set username='$fullname',password='$password',email='$email',role_id='$role_id' where email='$email_old'";
                        }else{
                            $qrup = "update users set username='$fullname',email='$email', avatar='$filename',role_id='$role_id', password='$password' where email='$email_old'";
                        }
